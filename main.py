...
st.set_page_config(page_title='csv App based on house price prediction',
                   layout='wide')
...
Try adjusting the hyperparameters! (Please Note Only Numbers Based csv can run properly)
""")
